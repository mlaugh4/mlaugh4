...
image: /assets/images/msurvey/msurvey-1.png
---
mSurvey is a research technology company out of MIT that connects health researchers and businesses with populations in hard-to-reach areas using SMS. After spending a summer in Nairobi, I continued to provide design and front-end development support during my second year of grad school.
...
- Created business plan and prototype to secure initial grant
- Designed and built front-end of web application
- Designed and built interface elements in Unity (Canvas)
- Concepted & designed ‘Touch Motion’
- Designed and built HoloLens web controller
- Shadowed and interviewed doctors: synthesized needs and constraints
